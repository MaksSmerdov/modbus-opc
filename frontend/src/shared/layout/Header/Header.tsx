    ...
    <header className={styles['header']}>
      ...
      <div className={styles['header__right']}>
        ...
        <IconButton
          icon={<HelpOutline />}
          onClick={handleDocs}
          className={`${styles['header__docsButton']} ${isDocsPage ? styles['header__docsButton_active'] : ''}`}
          tooltip='Документация по режимам'
          active={isDocsPage}
        />
        ...
        {isAuthenticated && (
          <div className={styles['header__user']}>
            ...
            <IconButton
              ...
              className={`${styles['header__monitorButton']} ${
                isMonitorPage ? styles['header__monitorButton_active'] : ''
              }`}
              tooltip='Мониторинг'
            ...
            {isAdmin && (
              <IconButton
                ...
                onClick={handleAdmin}
                className={`${styles['header__adminButton']} ${
                  isAdminPage ? styles['header__adminButton_active'] : ''
                }`}
