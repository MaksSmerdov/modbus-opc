...
export const AddPortForm = ({
  ...
  const [connectionType, setConnectionType] = useState<ConnectionType>(initialData?.connectionType || 'RTU');
      ...
      <form onSubmit={handleSubmit(onFormSubmit)} className={styles['form']}>
        <div className={styles['form__header']}>
          ...
          >
            ...
            <MenuItem value='TCP_RTU'>TCP (RTU over TCP)</MenuItem>
          </Select>
        ...
        {watchedConnectionType === 'RTU' ? (
          <RTUFields isLoading={isLoading} errors={errors} watchedConnectionType={watchedConnectionType} />
        ) : (
          <TCPFields isLoading={isLoading} errors={errors} watchedConnectionType={watchedConnectionType} />
        )}
